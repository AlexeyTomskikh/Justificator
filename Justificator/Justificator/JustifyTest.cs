...
namespace Justificator
{
    public class JustifyTest
    {
        ...
        public void MakeStrings_Test()
        {
            ...
            var result1 = form.MakeStrings(7, testString1);
            var result2 = form.MakeStrings(6, testString2);
        ...
        public void MakeStrings_Test_Negative()
        {
            ...
            Assert.Throws<ArgumentException>(() => form.MakeStrings(4, testString));
        }
        ...
        public void MakeStringsWithBigData_Test()
        {
            ...
            var list = form.MakeStrings(60, testString);
